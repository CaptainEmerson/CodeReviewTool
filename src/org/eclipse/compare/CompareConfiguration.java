...
public class CompareConfiguration {
	...
	private DocumentMerger fInmMergerResult;

	public DocumentMerger getInmMergerResult() {
		return fInmMergerResult;
	}

	public void setInmMergerResult(DocumentMerger fInmMergerResult) {
		this.fInmMergerResult = fInmMergerResult;
	}
