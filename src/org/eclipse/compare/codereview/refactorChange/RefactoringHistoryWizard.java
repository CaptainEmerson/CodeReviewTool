...
import org.eclipse.ltk.internal.ui.refactoring.history.*;
	...
	*//**
	...
	public boolean performFinish() {
		...
		if (wizard.getCurrentPage() == fPreviewPage && last) {
			...
			/*try {
				ModalContext.run(new WorkbenchRunnableAdapter(operation, ResourcesPlugin.getWorkspace().getRoot()), false, null, (new Shell()).getDisplay());
			...
			if (!result.isOK()) {
				fHeadlessErrorStatus= true;
				System.err.println(RefactoringUIMessages.RefactoringHistoryPreviewPage_finish_error_title);
				System.err.println(RefactoringUIMessages.RefactoringHistoryPreviewPage_finish_error_description);
