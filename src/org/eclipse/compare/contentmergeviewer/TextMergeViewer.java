...
import org.eclipse.compare.codereview.compareEditor.IgnoreRefactorChangesAction;
...
public class TextMergeViewer extends ContentMergeViewer implements IAdaptable {
	...
	private IgnoreRefactorChangesAction ignoreRefactorChangesAction;
	...
	protected void handleDispose(DisposeEvent event) {
		...
		if (ignoreRefactorChangesAction != null)
			ignoreRefactorChangesAction.dispose();
...
//			return;
	...
	/**
	 * added for codeReviewTool
	 * @return
	 */
	public DocumentMerger getfMerger() {
		return fMerger;
	}
